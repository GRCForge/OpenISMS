...
const catalog = [
  ...
  { ref: '5.1',  theme: 'Organizational', title: 'Policies for information security',
    description: 'Rules for information security and topic-specific policies shall be defined, approved by management, published, communicated to and acknowledged by relevant personnel and relevant interested parties, and reviewed at planned intervals and if significant changes occur.' },
  { ref: '5.2',  theme: 'Organizational', title: 'Information security roles and responsibilities',
  ...
  { ref: '5.3',  theme: 'Organizational', title: 'Segregation of duties',
    description: 'Conflicting duties and conflicting areas of responsibility shall be segregated.' },
  { ref: '5.4',  theme: 'Organizational', title: 'Management responsibilities',
  ...
  { ref: '5.5',  theme: 'Organizational', title: 'Contact with authorities',
    description: 'The organization shall establish and maintain contact with relevant authorities.' },
  { ref: '5.6',  theme: 'Organizational', title: 'Contact with special interest groups',
  ...
  { ref: '5.7',  theme: 'Organizational', title: 'Threat intelligence',
  ...
  { ref: '5.8',  theme: 'Organizational', title: 'Information security in project management',
    description: 'Information security shall be integrated into project management.' },
  { ref: '5.9',  theme: 'Organizational', title: 'Inventory of information and other associated assets',
    description: 'An inventory of information and other associated assets, including owners, shall be developed and maintained.' },
  { ref: '5.10', theme: 'Organizational', title: 'Acceptable use of information and other associated assets',
  ...
  { ref: '5.11', theme: 'Organizational', title: 'Return of assets',
  ...
  { ref: '5.12', theme: 'Organizational', title: 'Classification of information',
  ...
  { ref: '5.13', theme: 'Organizational', title: 'Labelling of information',
  ...
  { ref: '5.14', theme: 'Organizational', title: 'Information transfer',
  ...
  { ref: '5.15', theme: 'Organizational', title: 'Access control',
  ...
  { ref: '5.16', theme: 'Organizational', title: 'Identity management',
    description: 'The full life cycle of identities shall be managed.' },
  { ref: '5.17', theme: 'Organizational', title: 'Authentication information',
  ...
  { ref: '5.18', theme: 'Organizational', title: 'Access rights',
  ...
  { ref: '5.19', theme: 'Organizational', title: 'Information security in supplier relationships',
  ...
  { ref: '5.20', theme: 'Organizational', title: 'Addressing information security within supplier agreements',
  ...
  { ref: '5.21', theme: 'Organizational', title: 'Managing information security in the ICT supply chain',
  ...
  { ref: '5.22', theme: 'Organizational', title: 'Monitoring, review and change management of supplier services',
  ...
  { ref: '5.23', theme: 'Organizational', title: 'Information security for use of cloud services',
  ...
  { ref: '5.24', theme: 'Organizational', title: 'Information security incident management planning and preparation',
  ...
  { ref: '5.25', theme: 'Organizational', title: 'Assessment and decision on information security events',
  ...
  { ref: '5.26', theme: 'Organizational', title: 'Response to information security incidents',
    description: 'Information security incidents shall be responded to in accordance with the documented procedures.' },
  { ref: '5.27', theme: 'Organizational', title: 'Learning from information security incidents',
  ...
  { ref: '5.28', theme: 'Organizational', title: 'Collection of evidence',
  ...
  { ref: '5.29', theme: 'Organizational', title: 'Information security during disruption',
    description: 'The organization shall plan how to maintain information security at an appropriate level during disruption.' },
  { ref: '5.30', theme: 'Organizational', title: 'ICT readiness for business continuity',
  ...
  { ref: '5.31', theme: 'Organizational', title: 'Legal, statutory, regulatory and contractual requirements',
  ...
  { ref: '5.35', theme: 'Organizational', title: 'Independent review of information security',
  ...
  { ref: '5.36', theme: 'Organizational', title: 'Compliance with policies, rules and standards for information security',
  ...
  { ref: '5.37', theme: 'Organizational', title: 'Documented operating procedures',
  ...
  { ref: '6.1', theme: 'People', title: 'Screening',
  ...
  { ref: '6.2', theme: 'People', title: 'Terms and conditions of employment',
  ...
  { ref: '6.3', theme: 'People', title: 'Information security awareness, education and training',
  ...
  { ref: '6.4', theme: 'People', title: 'Disciplinary process',
  ...
  { ref: '6.5', theme: 'People', title: 'Responsibilities after termination or change of employment',
  ...
  { ref: '6.6', theme: 'People', title: 'Confidentiality or non-disclosure agreements',
  ...
  { ref: '6.7', theme: 'People', title: 'Remote working',
  ...
  { ref: '6.8', theme: 'People', title: 'Information security event reporting',
  ...
  { ref: '7.1',  theme: 'Physical', title: 'Physical security perimeters',
  ...
  { ref: '7.6',  theme: 'Physical', title: 'Working in secure areas',
    description: 'Security measures for working in secure areas shall be designed and implemented.' },
  { ref: '7.7',  theme: 'Physical', title: 'Clear desk and clear screen',
  ...
  { ref: '7.8',  theme: 'Physical', title: 'Equipment siting and protection',
    description: 'Equipment shall be sited securely and protected.' },
  { ref: '7.9',  theme: 'Physical', title: 'Security of assets off-premises',
    description: 'Off-site assets shall be protected.' },
  { ref: '7.10', theme: 'Physical', title: 'Storage media',
  ...
  { ref: '7.11', theme: 'Physical', title: 'Supporting utilities',
  ...
  { ref: '7.12', theme: 'Physical', title: 'Cabling security',
  ...
  { ref: '7.13', theme: 'Physical', title: 'Equipment maintenance',
    description: 'Equipment shall be maintained correctly to ensure availability, integrity and confidentiality of information.' },
  { ref: '7.14', theme: 'Physical', title: 'Secure disposal or re-use of equipment',
  ...
  { ref: '8.1',  theme: 'Technological', title: 'User endpoint devices',
    description: 'Information stored on, processed by or accessible via user endpoint devices shall be protected.' },
  { ref: '8.2',  theme: 'Technological', title: 'Privileged access rights',
    description: 'The allocation and use of privileged access rights shall be restricted and managed.' },
  { ref: '8.3',  theme: 'Technological', title: 'Information access restriction',
  ...
  { ref: '8.9',  theme: 'Technological', title: 'Configuration management',
  ...
  { ref: '8.10', theme: 'Technological', title: 'Information deletion',
  ...
  { ref: '8.11', theme: 'Technological', title: 'Data masking',
  ...
  { ref: '8.12', theme: 'Technological', title: 'Data leakage prevention',
  ...
  { ref: '8.13', theme: 'Technological', title: 'Information backup',
  ...
  { ref: '8.14', theme: 'Technological', title: 'Redundancy of information processing facilities',
  ...
  { ref: '8.15', theme: 'Technological', title: 'Logging',
  ...
  { ref: '8.16', theme: 'Technological', title: 'Monitoring activities',
  ...
  { ref: '8.17', theme: 'Technological', title: 'Clock synchronisation',
  ...
  { ref: '8.18', theme: 'Technological', title: 'Use of privileged utility programs',
  ...
  { ref: '8.19', theme: 'Technological', title: 'Installation of software on operational systems',
    description: 'Procedures and measures shall be implemented to securely manage software installation on operational systems.' },
  { ref: '8.20', theme: 'Technological', title: 'Networks security',
  ...
  { ref: '8.21', theme: 'Technological', title: 'Security of network services',
  ...
  { ref: '8.22', theme: 'Technological', title: 'Segregation of networks',
  ...
  { ref: '8.23', theme: 'Technological', title: 'Web filtering',
    description: 'Access to external websites shall be managed to reduce exposure to malicious content.' },
  { ref: '8.24', theme: 'Technological', title: 'Use of cryptography',
    description: 'Rules for the effective use of cryptography, including cryptographic key management, shall be defined and implemented.' },
  { ref: '8.25', theme: 'Technological', title: 'Secure development life cycle',
    description: 'Rules for the secure development of software and systems shall be established and applied.' },
  { ref: '8.26', theme: 'Technological', title: 'Application security requirements',
  ...
  { ref: '8.27', theme: 'Technological', title: 'Secure system architecture and engineering principles',
  ...
  { ref: '8.28', theme: 'Technological', title: 'Secure coding',
    description: 'Secure coding principles shall be applied to software development.' },
  { ref: '8.29', theme: 'Technological', title: 'Security testing in development and acceptance',
    description: 'Security testing processes shall be defined and implemented in the development life cycle.' },
  { ref: '8.30', theme: 'Technological', title: 'Outsourced development',
    description: 'The organization shall direct, monitor and review the activities related to outsourced system development.' },
  { ref: '8.31', theme: 'Technological', title: 'Separation of development, test and production environments',
    description: 'Development, testing and production environments shall be separated and secured.' },
  { ref: '8.32', theme: 'Technological', title: 'Change management',
  ...
  { ref: '8.33', theme: 'Technological', title: 'Test information',
    description: 'Test information shall be appropriately selected, protected and managed.' },
  { ref: '8.34', theme: 'Technological', title: 'Protection of information systems during audit testing',
